...
impl Deserialize for Section {
    ...
    fn deserialize<R: io::Read>(reader: &mut R) -> Result<Self, Self::Error> {
        ...
        Ok(match id.into() {
            0 => Section::Custom(CustomSection::deserialize(reader)?.into()),
...
mod tests {
    ...
    use super::super::{
        deserialize_buffer, deserialize_file, serialize, BlockType, DataSegment, ElementSegment,
        FuncBody, InitExpr, Instructions, Local, ValueType,
    };
    use super::{CodeSection, DataSection, ElementSection, Section, Type, TypeSection};
    ...
    fn fn_section_detect() {
        ...
        match section {
            Section::Function(_) => {}
            _ => panic!("Payload should be recognized as functions section"),
        }
    }
    ...
    fn export_detect() {
        ...
        match section {
            Section::Export(_) => {}
            _ => panic!("Payload should be recognized as export section"),
        }
    }
    ...
    fn code_detect() {
        ...
        match section {
            Section::Code(_) => {}
            _ => panic!("Payload should be recognized as a code section"),
        }
    }
    ...
    fn data_section_detect() {
        ...
        match section {
            Section::Data(_) => {}
            _ => panic!("Payload should be recognized as a data section"),
        }
    }
    ...
    fn start_section() {
        let section: Section =
            deserialize_buffer(&[08u8, 01u8, 00u8]).expect("Start section to deserialize");
