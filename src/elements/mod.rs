...
pub use self::import_entry::{
    External, GlobalType, ImportEntry, MemoryType, ResizableLimits, TableType,
};
pub use self::module::{peek_size, ImportCountType, Module};
pub use self::ops::{opcodes, BrTableData, InitExpr, Instruction, Instructions};
...
pub use self::types::{BlockType, FunctionType, TableElementType, Type, ValueType};
...
pub use self::reloc_section::{RelocSection, RelocationEntry};
